...
2. Generate and lock DESIGN_GENOME.
3. Write SIGNATURE_DECISION, three identity decisions, and REJECTED_DEFAULT.
4. Compare the provisional fingerprint with previous projects when available.
5. Run the direction through the strict anti-slop gate.
6. Build composition and content before motion.
7. Load only the recipes used by the approved direction.
8. Run deterministic checks, screenshot QA, and an independent or inline critique.
9. Finalize .cdesign/INTENT.md and .cdesign/FINGERPRINT.json.
